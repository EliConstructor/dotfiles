...
function show_volume_notif {
    ...
    if [[ $show_music_in_volume_indicator == "true" ]]; then
        ...
        notify-send -i none -t $notification_timeout -h string:x-dunst-stack-tag:volume_notif -h int:value:$volume "$volume_icon $volume%"
    fi
}
...
function show_brightness_notif {
    ...
    echo $brightness
    get_brightness_icon
    notify-send -t $notification_timeout -h string:x-dunst-stack-tag:brightness_notif -h int:value:$brightness "$brightness_icon $brightness%" -i none
}
